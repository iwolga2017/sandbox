...
// If the string is less than 4 characters, return "Error: 
// Name too short".
// Notes:
// Vowels are "aeiou", so discount the letter "y".
// Input will always be a string.
// Input will always have the first letter capitalised 
// and the rest lowercase (e.g. Sam).
...
function nicknameGenerator(name){
    ...
    name[2].match(regExp) ? name.slice(0, 3) :
    name.slice(0, 4);
