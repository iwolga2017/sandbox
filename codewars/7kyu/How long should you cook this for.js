...
// minutes and 20 seconds, based on a 600W microwave.
// Oh no, your microwave is 800W! How long should you cook 
// this for?!
// Input
...
// Example: "800W"
// Output
// The amount of time you should cook the meal for formatted as 
// a string.
...
function cookingTime(neededPower, minutes, seconds, power) {
    ...
    let time = minToSec + seconds;
    let newTime = Math.ceil((parseInt(neededPower) * time) / parseInt(power));
