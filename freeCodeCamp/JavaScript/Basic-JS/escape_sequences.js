// Assign the following three lines of text into the 
// single variable myStr using escape sequences.
...
// Note: The indentation for SecondLine is achieved with the tab escape character, 
// not spaces.
