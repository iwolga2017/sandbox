...
function getRating(watchList) {
  ...
  let lengthOfNolanList = watchList.filter(movie => movie.Director == "Christopher Nolan").length;
    
  let avergeRating = watchList
  .filter(movie => movie.Director == "Christopher Nolan")
  .reduce((sum, item) => sum + Number(item.imdbRating), 0) / 
     lengthOfNolanList;
