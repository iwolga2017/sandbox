...
// The final list of open tabs, stored in finalTabs.tabs, should 
// be ['FB', 'Gitter', 'Reddit', 'Twitter', 'Medium', 'new tab', 
// 'Netflix', 'YouTube', 'Vine', 'GMail', 'Work mail', 'Docs', 
// 'freeCodeCamp', 'new tab'] but the list produced by the code 
